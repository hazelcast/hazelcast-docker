...
export CLASSPATH=$HAZELCAST_HOME/hazelcast-enterprise-$HZ_VERSION/lib/hazelcast-enterprise-all-$HZ_VERSION.jar:$HAZELCAST_HOME/cache-api-1.0.0.jar:$CLASSPATH/*
echo "########################################"
